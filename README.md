...
## Setting up business profile and adding departments. (Click images for larger view)
...
## Setting up store locations and hiring managers to be assigned to created store locations. (Click images for larger view)
| Setup Store Locations | Hiring Managers |
| ------ | ------ |
